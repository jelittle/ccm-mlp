...
class ThreeCST(nn.Module):
    def __init__(self):
        super(ThreeCST, self).__init__()
        self.low_temp_cst = None
        self.mid_temp_cst = None
    ...
    def forward(self,white_point, wb_img):
        ...
        output=estimate_cst(white_point, self.low_temp_cst, self.high_temp_cst, self.mid_temp_cst).to(wb_img.device)
